            ...
            <div class="login-form-inner">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="login-form-group single-row">
                        ...
                        @if (Route::has('password.request'))
                            <a class="link forgot-link" href="{{ route('password.request') }}">
                                {{ __('Forgot your password?') }}
                            </a>
                        @endif
                    </div>

                    {{-- <a  class="rounded-button login-cta">{{ __('Log in') }}</a> --}}
                    <input type="submit" class="rounded-button login-cta" value="{{ __('Log in') }}">
