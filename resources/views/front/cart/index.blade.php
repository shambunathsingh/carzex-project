        ...
        <div class="container">
            ...
            <div id="cartHolder" class="row mt-5 p-3">
                ...
                <div class="col-md-8 m-0 p-0 ">
                    ...
                    <div class="border-box shadow p-3 mb-4 mx-4" style="height: fit-content;">
                        <div class="row">
                            <!-- Product Details -->
                            <div class="col-md-6">
...
">
                                    <div class="col-md-4">
                                        <a href="{{ route('single_product', ['slug' => $cartItem->product->slug]) }}">
                                            @if ($cartItem->product->images)
                                            @php
                                            // Split the string by '!' to separate the URL from the alt text
                                            $imageParts = explode('!', $cartItem->product->images);
                    ...
                    <div id="couponHolder" class="col-md-12 mt-5 d-flex justify-content-between align-items-center p-3">
                        <div class="col-md-6 d-flex">
                            <div class="form-group">
                                <input type="text" name="" id="" class="d-inline-block form-control shadow-sm"
                                    value="Coupon code">
                            </div>
                ...
                {{-- <div id="rightCartDiv" class="col-md-4 col-12 rounder p-3 shadow"> --}}
                    <div id="rightCartDiv" class="col-md-4 col-12 rounder p-3 shadow" style="
    height: fit-content;
">
                        <div class="">
...
<script>
    $(document).ready(function () {
        ...
        $('.quantity__minus').off('click').on('click', function (e) {
            e.preventDefault();
        ...
        $('.quantity__plus').off('click').on('click', function (e) {
            e.preventDefault();
            const productId = $(this).data('id');
            const quantityInput = $(`#quantity_${productId}`);
            let quantity = parseInt(quantityInput.val(), 10);
        ...
        $('.quantity__input').off('input').on('input', function () {
            const productId = $(this).data('id');
