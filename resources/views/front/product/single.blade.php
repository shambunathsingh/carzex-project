                                        ...
                                        <div class="card-body ">
                                            ...
                                            <div class="productprice">
                                                @if($recentlyViewedProduct->sale_price)
                                                    <p><span>MRP:</span> <span class="fdsm" style="text-decoration-line: line-through; color: gray;">₹{{ number_format($recentlyViewedProduct->sale_price * 1.30, 2) }}
</span></p>
                                                @endif
