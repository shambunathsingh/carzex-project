                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.blog.tag.add_tags') }}"
                                ...
                                <table
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th title="Status" width="100px" class="text-center column-key-status sorting"
                                                tabindex="0" aria-controls="botble-page-tables-page-table" rowspan="1"
                                        ...
                                        @foreach ($ptags as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-name">
                                                    <a href="{{ route('admin.blog.tag.edit_tags', ['id' => $item->id]) }}">
                                                        {{ $item->name }}</a>
                                                </td>
                                                ...
                                                <td class=" text-center language-header no-sort" style="">
                                                    <div class="text-center language-column">
                                                        <a
                                                            href="{{ route('admin.blog.tag.edit_tags', ['id' => $item->id]) }}">
                                                ...
                                                <td class=" text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        <a href="{{ route('admin.blog.tag.delete_tags', ['id' => $item->id]) }}"
