...
@section('content')
    <form action="{{ route('admin.blog.update_posts', ['id' => $post->id]) }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="main-panel">
            <ol class="breadcrumb" v-pre="">
                ...
                <li><a class="breadcrumb-item">Edit post</a>
                </li>
            </ol>
                            ...
                            <div class="tab-pane active" id="tab_detail">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" placeholder="Name" data-counter="120" v-pre=""
                                        ...
                                        value="{{ $post->name }}" aria-describedby="name-error"><span id="name-error"
                                        class="invalid-feedback" style="display: inline;"></span>
                                    {{-- <small
                                ...
                                <div class="form-group mb-3 ">
                                    <div id="edit-slug-box" data-field-name="name">
                                        ...
                                        <textarea class="form-control" rows="4" placeholder="Short description" data-counter="400" v-pre=""
                                            name="description" cols="50" id="description" spellcheck="false">{{ $post->name }}</textarea>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" rows="4" placeholder="Short description" data-counter="400" v-pre=""
                                        name="content" cols="50" id="content" spellcheck="false">{{ $post->content }}</textarea>
                                    {{-- <small class="charcounter">(400
                                        character(s) remain)</small> --}}
                                ...
                                <div class="widget-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="time_to_read" name="time_to_read"
                                            value="{{ $post->time_to_read }}" type="number">
                                    </div>
                                        ...
                                        <div class="ui-select-wrapper form-group ">
                                            <select class="form-control ui-select" id="layout" name="layout">
                                                <option value="inherit"
                                                    {{ $post->layout == 'inherit' ? 'selected' : '' }}>
                                                    Inherit</option>
                                                <option value="blog-post-right-sidebar"
                                                    {{ $post->layout == 'blog-post-right-sidebar' ? 'selected' : '' }}>
                                                    Post Right Sidebar
                                                </option>
                                                <option value="blog-post-left-sidebar"
                                                    {{ $post->layout == 'blog-post-left-sidebar' ? 'selected' : '' }}>
                                                    Post Left Sidebar
                                                </option>
                                                <option value="blog-post-full-width"
                                                    {{ $post->layout == 'blog-post-full-width' ? 'selected' : '' }}>
                                                    Post Full Width
                                                </option>
                                            </select>
                                                        ...
                                                        <li value="{{ $item->id }}">
                                                            <label class="mb-2">
                                                                <input type="checkbox" value="{{ $item->id }}"
                                                                    {{ $post->categories == $item->id ? 'checked' : '' }}
                                                                    name="categories">
                                                                {{ $item->name }}
                                                            </label>
                        ...
                        <div class="widget meta-boxes">
                            ...
                            <div class="widget-body">
                                ...
                                <input class="tags" placeholder="Write some tags" data-url="" v-pre=""
                                    name="tag" type="text" value="{{ $post->tag }}" id="tag"
                                    tabindex="-1">
