...
@section('content')
    <form action="{{ route('admin.countries.update_country', ['id' => $country->id]) }}" method="post"
            ...
            <div class="pagesbodyarea">
                <div class="pageinfo">
                    <ul class="d-flex">
                        ...
                        <li><a class="breadcrumb-item">Edit '{{ $country->name }}'</a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="tab-pane active" id="tab_detail">
                                    ...
                                    <div class="form-group mb-3 ">
                                        <div id="edit-slug-box" data-field-name="order">
                                            ...
                                            <input type="text" name="nationality" class="form-control"
                                                placeholder="Nationality" value="{{ $country->nationality }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3 ">
                                        <div id="edit-slug-box" data-field-name="order">
                                            ...
                                            <input type="number" name="order" class="form-control" value="{{ $country->order }}">
                                        </div>
                                        <div class="m-1 form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                {{ $country->is_default == '1' ? 'checked' : '' }} value="1"
                                ...
                                <div class="widget-body">
                                    <div class="ui-select-wrapper form-group ">
                                        <select class="form-control ui-select" v-pre="" id="status"
                                            name="status">
                                            <option
                                                value="published"{{ $country->status == 'published' ? 'selected' : '' }}>
                                                Published</option>
                                            <option value="draft"{{ $country->status == 'draft' ? 'selected' : '' }}>
                                                Draft
                                            </option>
                                            <option value="pending"{{ $country->status == 'pending' ? 'selected' : '' }}>
                                                Pending
                                            </option>
                                        </select>
