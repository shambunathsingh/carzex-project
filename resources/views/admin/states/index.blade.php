                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.states.add_state') }}"
                                        ...
                                        @foreach ($stateList as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-name">
                                                    <a
                                                        href="{{ route('admin.states.edit_state', ['id' => $item->id]) }}">{{ $item->name }}</a>
                                                </td>
                                                <td class=" text-start column-key-template" style="">
                                                    @if (isset($country[$item->id]))
                                                        {{ $country[$item->id] }}
                                                    @else
                                                ...
                                                <td class=" text-center language-header no-sort" style="">
                                                    <div class="text-center language-column">
                                                        <a
                                                            href="{{ route('admin.states.edit_state', ['id' => $item->id]) }}">
                                                ...
                                                <td class=" text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        <a href="{{ route('admin.states.edit_state', ['id' => $item->id]) }}"
                                                            class="btn btn-icon btn-sm btn-primary"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Edit"><i
                                                                class="fa fa-edit"></i></a>

                                                        <a href="{{ route('admin.states.delete_state', ['id' => $item->id]) }}"
