        ...
        <div id="main">
            ...
            <div class="breadcambarea">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="blog-posts.html" style="color: black; margin-right: 3px;">FAQ</a>
                    </li>
                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.faq-categories.add_faqs_category') }}"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th title="Operations" width="134px" class="text-center sorting_disabled"
                                                ...
                                                aria-label="Operations">Operations
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($faqcats as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-name"><a
                                                        href="{{ route('admin.faq-categories.edit_faqs_category', ['id' => $item->id]) }}">{{ $item->name }}</a>
                                                </td>
                                                ...
                                                <td class=" text-center language-header no-sort" style="">
                                                    <div class="text-center language-column">
                                                        <a
                                                            href="{{ route('admin.faq-categories.edit_faqs_category', ['id' => $item->id]) }}">
                                                ...
                                                <td class=" text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        <a href="{{ route('admin.faq-categories.edit_faqs_category', ['id' => $item->id]) }}"
                                                            class="btn btn-icon btn-sm btn-primary"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Edit"><i
                                                                class="fa fa-edit"></i></a>

                                                        <a href="{{ route('admin.faq-categories.delete_faqs_category', ['id' => $item->id]) }}"
