                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.faq.add_faqs') }}"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th title="Template" class="text-start column-key-template sorting"
                                                tabindex="0" aria-controls="botble-page-tables-page-table" rowspan="1"
                                                colspan="1" aria-label="Templateorderby asc" style="">Category
                                            </th>
                                    ...
                                    <tbody>
                                        @foreach ($faqs as $item)
                                            @php
                                                ...
                                                $catMap = [];
                                                foreach ($faqcats as $faqitem) {
                                                    $catMap[$faqitem->id] = $faqitem->name;
                                                }

                                                // Look up the category name for the current FAQ item
                                                $cat = isset($catMap[$item->cat_id]) ? $catMap[$item->cat_id] : '';
                                            @endphp
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="text-start column-key-name">
                                                    <a
                                                        href="{{ route('admin.faq.edit_faqs', ['id' => $item->id]) }}">{{ $item->question }}</a>
                                                </td>
                                                <td class="text-start column-key-template">{{ $cat }}</td>
                                                <td class="text-center column-key-created_at">
                                                    {{ $item->created_at->format('d-m-Y') }}</td>
                                                <td class="text-center column-key-status">
                                                ...
                                                <td class="text-center language-header no-sort">
                                                    <div class="text-center language-column">
                                                        <a href="{{ route('admin.faq.edit_faqs', ['id' => $item->id]) }}">
                                                ...
                                                <td class="text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        <a href="{{ route('admin.faq.delete_faqs', ['id' => $item->id]) }}"
