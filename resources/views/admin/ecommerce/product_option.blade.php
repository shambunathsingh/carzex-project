        ...
        <div id="main">
            ...
            <div class="breadcambarea">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">Product Option</li>
                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.ecommerce.create_product_option') }}"
                                        ...
                                        @foreach ($product_options as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-name">
                                                    <a
                                                        href="{{ route('admin.ecommerce.edit_product_option', ['id' => $item->id]) }}">
                                                        {{ $item->name }}
                                                    </a>
                                                </td>
                                                ...
                                                <td class=" text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        <a href="{{ route('admin.ecommerce.edit_product_option', ['id' => $item->id]) }}"
                                                            class="btn btn-icon btn-sm btn-primary"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Edit"><i
                                                                class="fa fa-edit"></i></a>

                                                        <a href="{{ route('admin.ecommerce.delete_product_option', ['id' => $item->id]) }}"
