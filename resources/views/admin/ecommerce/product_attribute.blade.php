                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.ecommerce.create_product_attributes') }}"
                                        ...
                                        @foreach ($pattribute as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-name">
                                                    <a
                                                        href="{{ route('admin.ecommerce.edit_product_attributes', ['id' => $item->id]) }}">{{ $item->title }}</a>
                                                </td>
                                                ...
                                                <td class=" text-center language-header no-sort" style="">
                                                    <div class="text-center language-column">
                                                        <a
                                                            href="{{ route('admin.ecommerce.edit_product_attributes', ['id' => $item->id]) }}">
                                                ...
                                                <td class=" text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        <a href="{{ route('admin.ecommerce.edit_product_attributes', ['id' => $item->id]) }}"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Edit"><i
                                                                class="fa fa-edit"></i></a>

                                                        <a href="{{ route('admin.ecommerce.delete_product_attributes', ['id' => $item->id]) }}"
