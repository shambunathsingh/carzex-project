        ...
        <div id="main">
            ...
            <div class="breadcambarea">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">Product Collection</li>
                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.ecommerce.create_product_collection') }}"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th title="Template" class="text-start column-key-template sorting"
                                                tabindex="0" aria-controls="botble-page-tables-page-table" rowspan="1"
                                                colspan="1" aria-label="Templateorderby asc" style="">Image
                                            </th>
                                            <th title="Template" class="text-start column-key-template sorting"
                                        ...
                                        @foreach ($pcollection as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-name">
                                                    <img src="{{ asset('storage/product_collections/' . $item->image) }}" data-default="{{ $item->image }}"
                                                        alt="Preview image" class="preview_image" width="100">

                                                </td>
                                                <td class=" text-center column-key-name" style="">
                                                    <a
                                                        href="{{ route('admin.ecommerce.edit_product_collection', ['id' => $item->id]) }}">
                                                        {{ $item->name }}</a>
                                                </td>
                                                <td class=" text-center column-key-slug" style="">
                                                    {{ $item->slug }}</td>
                                                ...
                                                <td class=" text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        <a href="{{ route('admin.ecommerce.edit_product_collection', ['id' => $item->id]) }}"
                                                            class="btn btn-icon btn-sm btn-primary"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Edit"><i
                                                                class="fa fa-edit"></i></a>

                                                        <a href="{{ route('admin.ecommerce.delete_product_collection', ['id' => $item->id]) }}"
