                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.ecommerce.create_taxes') }}"
                                        ...
                                        @foreach ($taxes as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-name">
                                                    <a href="{{ route('admin.ecommerce.edit_tax', ['id' => $item->id]) }}">
                                                        {{ $item->title }}
                                                    </a>
                                                </td>
                                                <td class=" text-start column-key-percentage">
                                                    {{ $item->percentage }} %
                                                </td>
                                                <td class=" text-start column-key-percentage">
                                                    {{ $item->priority }}
                                                ...
                                                <td class=" text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        <a href="{{ route('admin.ecommerce.delete_tax', ['id' => $item->id]) }}"
