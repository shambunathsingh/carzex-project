        ...
        <div id="main">
            ...
            <div class="breadcambarea">
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('admin.ecommerce.product') }}" class="breadcrumb-item ">Ecommerce /</a></li>
                    <li class="breadcrumb-item ">Product Tags</li>
                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.ecommerce.create_product_tags') }}"
                                        ...
                                        @foreach ($tags as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-name"><a
                                                        href="{{ route('admin.ecommerce.edit_product_tags', ['id' => $item->id]) }}">{{ $item->name }}</a>
                                                </td>
                                                ...
                                                <td class="text-center">
                                                    <div class="table-actions">
                                                        <a href="{{ route('admin.ecommerce.edit_product_tags', ['id' => $item->id]) }}"
                                                            class="btn btn-icon btn-sm btn-primary"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Edit"><i
                                                                class="fa fa-edit"></i></a>

                                                        <a href="{{ route('admin.ecommerce.delete_product_tags', ['id' => $item->id]) }}"
