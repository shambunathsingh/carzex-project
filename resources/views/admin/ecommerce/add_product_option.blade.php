...
@section('content')
    <form action="{{ route('admin.ecommerce.save_product_option') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="main-panel">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('admin.ecommerce.product_option') }}"
                        ...
                        options</a></li>
                <li class="breadcrumb-item active">New option
                </li>
            </ol>
                                ...
                                <div class="widget-body">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" role="switch" value="1"
                                            name="is_required" id="flexSwitchCheckChecked">
