...
@section('content')
    <form action="{{ route('admin.ecommerce.save_carmodel') }}" method="post" enctype="multipart/form-data">
        @csrf
            ...
            <div class="pagesbodyarea">
                <div class="pageinfo">
                    <ul class="d-flex">
                        ...
                        <li><a class="breadcrumb-item">New Car model</a>
                        </li>
                    </ul>
                </div>
                                ...
                                <div class="tab-pane active" id="tab_detail">
                                    <div class="form-group mb-3">
                                        ...
                                        <label for="name" class="control-label required"
                                            aria-required="true">Car model</label>
                                        <input class="form-control" placeholder="Car model" data-counter="120" v-pre=""
                                            name="car_model" type="text" id="car_model" aria-invalid="false"
