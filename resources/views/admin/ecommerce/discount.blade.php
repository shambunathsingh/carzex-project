                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.ecommerce.create_discounts') }}"
                                                ...
                                                <a href="#" class="relode d-flex align-items-center">
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th title="Template" class="text-start column-key-template sorting"
                                                tabindex="0" aria-controls="botble-page-tables-page-table" rowspan="1"
                                                colspan="1" aria-label="Templateorderby asc" style="">Detail
                                            </th>
                                            <th title="Template" class="text-start column-key-template sorting"
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-name">
                                                        ...
                                                        <div class="discount">
                                                            <div class="discount-inner">
                                                                <p class="discount-code">
                                                                    <span class="text-uppercase">Discount Promotion</span>:
                                                                    <b>{{ $item->title }}</b>
                                                                </p>
                                                                <p class="discount-desc">
                                                                    Discount {{ $item->quantity }}
                                                                    @if ($item->type_option == 'percentage')
                                                                        %
                                                                    @endif
                                                                    for {{ $item->target }}
                                                                </p>
                                                    ...
                                                    @if ($item->code)
                                                        <div class="discount">
                                                            <div class="discount-inner">
                                                                <p class="discount-code"> <span
                                                                        class="text-uppercase">Coupon
                                                                        code</span>: <b>{{ $item->code }}</b> </p>
                                                                <p class="discount-desc">
                                                                    Discount {{ $item->quantity }}
                                                                    @if ($item->type_option == 'percentage')
                                                                        %
                                                                ...
                                                                <p class=" discount-text-color ">(Coupon code <b> cannot
                                                                    </b>
                                                                    be
                                                                    used with promotion).</p>
                                                            </div>
                                                        </div>
                                                    @endif
                                                </td>
                                                ...
                                                <td class=" text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        <a href="{{ route('admin.ecommerce.delete_discounts', ['id' => $item->id]) }}"
                                                            class="btn btn-icon btn-sm btn-danger deleteDialog"
                                                            data-bs-toggle="tooltip" data-section="" role="button"
                                                            style="background: darkred" data-bs-original-title="Delete"
