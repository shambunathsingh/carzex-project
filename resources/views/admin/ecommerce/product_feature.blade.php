        ...
        <div id="main">
            ...
            <div class="breadcambarea">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">Product Features</li>
                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.ecommerce.create_product_features') }}"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th title="Name" class="text-start column-key-name sorting" tabindex="0"
                                                ...
                                                colspan="1" aria-label="Nameorderby asc" style="">Description
                                            </th>
                                        ...
                                        @foreach ($pfeature as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-start column-key-name">
                                                    <a
                                                        href="{{ route('admin.ecommerce.edit_product_features', ['id' => $item->id]) }}">
                                                        {{ $item->name }}</a>
                                                </td>
                                                <td class=" text-start column-key-name">
                                                    <img src="{{ asset('storage/product_features/' . $item->image) }}"
                                                        data-default="{{ asset('storage/product_features/' . $item->image) }}"
                                                        alt="Preview image" width="50" class="preview_image">
                                                </td>
                                                <td class=" text-start column-key-name">
                                                    {{ $item->description }}
                                                </td>
                                                ...
                                                <td class=" text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        <a href="{{ route('admin.ecommerce.edit_product_features', ['id' => $item->id]) }}"
                                                            class="btn btn-icon btn-sm btn-primary"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Edit"><i
                                                                class="fa fa-edit"></i></a>

                                                        <a href="{{ route('admin.ecommerce.delete_product_features', ['id' => $item->id]) }}"
