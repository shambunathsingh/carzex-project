                        ...
                        <div class="table-responsive  table-has-actions   table-has-filter ">
                            <div id="botble-page-tables-page-table_wrapper"
                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                <a href="{{ route('admin.ecommerce.create_flash_sales') }}"
                                ...
                                <table
                                    ...
                                    <tbody>
                                       @foreach ($flash_sales_list as $item)
                                        <tr role="row" class="odd">
                                            <td class="text-start no-sort dtr-control">
                                                <div class="text-start">
                                                    <div class="checkbox checkbox-primary table-checkbox">
                                                        <input type="checkbox" class="checkboxes" name="{{ $item->id }}[]" value="">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="column-key-id sorting_1">{{ $item->id }}</td>
                                            <td class="text-start column-key-name">
                                                <a href="{{ route('admin.ecommerce.edit_product_flash_sales', ['id' => $item->id]) }}">{{ $item->name }}</a>
                                            </td>
                                            <td class="text-center column-key-end_date" style="color:red">
                                            ...
                                            <td class="text-center column-key-status" style="">
                                                <span class="label-success status-label">{{ $item->status ? 'Active' : 'Inactive' }}</span>
                                            </td>
                                            <td class="text-center language-header no-sort" style="">
                                                <div class="text-center language-column">
                                                    <a href="{{ route('admin.ecommerce.edit_product_flash_sales', ['id' => $item->id]) }}">
                                            ...
                                            <td class="text-center">
                                                <div class="table-actions">
                                                    ...
                                                    <a href="{{ route('admin.ecommerce.delete_flash_sales', ['id' => $item->id]) }}"
                                                        class="btn btn-icon btn-sm btn-danger deleteDialog" data-bs-toggle="tooltip" data-section="" role="button"
