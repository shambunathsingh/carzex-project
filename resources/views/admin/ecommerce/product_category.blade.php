                                                ...
                                                <div class="image-box">
                                                    ...
                                                    <div class="image-box-actions">
                                                        <a style="cursor: pointer;" class="btn_gallery"
                                                            ...
                                                            data-allow-thumb="1" id="choose_image_button">
                                                            Choose image
                                                        </a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group color-picker colorpicker-element"
                                                    ...
                                                    {{-- <input class="form-control is-valid" name="background_color"
                                                        type="text" value="#f4f6fa" aria-invalid="false"> --}}
                                                    ...
                                                    {{-- <span class="input-group-text">
                                                        <span class="input-group-text colorpicker-input-addon"
                                                            data-bs-original-title="" title="" tabindex="0"><i
                                                                style="background: rgb(244, 246, 250);"></i></span>
                                                    </span> --}}
                                                    {{-- <div
                                                        class="colorpicker colorpicker-popup colorpicker-bs-popover-content colorpicker-hidden">
                                                        <div class="colorpicker-saturation"
                                                            style="background-color: rgb(0, 85, 255);"><i
                                                                class="colorpicker-guide"
                                                                style="top: 2.47059px; left: 3.024px;"></i></div>
                                                        <div class="colorpicker-hue"><i class="colorpicker-guide"
                                                                style="top: 49px;"></i></div>
                                                        <div class="colorpicker-alpha">
                                                            <div class="colorpicker-alpha-color"
                                                                style="background: linear-gradient(rgb(244, 246, 250) 0%, transparent 100%);">
                                                            </div>
                                                            <i class="colorpicker-guide" style="top: 0px;"></i>
                                                        </div>
                                                        <div class="colorpicker-bar colorpicker-swatches">
                                                            <div class="colorpicker-swatches--inner"><i
                                                                    class="colorpicker-swatch" data-name="tetrad1"
                                                                    data-value="#F4F6FA" title="#F4F6FA"><i
                                                                        class="colorpicker-swatch--inner"
                                                                        style="background-color: rgb(244, 246, 250);"></i></i><i
                                                                    class="colorpicker-swatch" data-name="tetrad2"
                                                                    data-value="#FAF4F9" title="#FAF4F9"><i
                                                                        class="colorpicker-swatch--inner"
                                                                        style="background-color: rgb(250, 244, 249);"></i></i><i
                                                                    class="colorpicker-swatch" data-name="tetrad3"
                                                                    data-value="#FAF8F4" title="#FAF8F4"><i
                                                                        class="colorpicker-swatch--inner"
                                                                        style="background-color: rgb(250, 248, 244);"></i></i><i
                                                                    class="colorpicker-swatch" data-name="tetrad4"
                                                                    data-value="#F4FAF5" title="#F4FAF5"><i
                                                                        class="colorpicker-swatch--inner"
                                                                        style="background-color: rgb(244, 250, 245);"></i></i><i
                                                                    class="colorpicker-clear"></i></div>
                                                        </div>
                                                    </div> --}}
                                                </div>
