        ...
        <div id="main">
            ...
            <div class="breadcambarea">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item ">Export location</li>
                                    ...
                                    <div class="caption">
                                        <div class="wrapper-action d-flex justify-content-between py-3 px-3">
                                            ...
                                            <div class="button-grp d-flex">
                                                ...
                                                <a class="export d-flex align-items-center" style="cursor: pointer;"
                                                    data-toggle="modal" data-target="#exampleModal">
                                                    <i class="fas fa-cloud-download btn-icon"></i>
                                                    <p>Export</p>
                                                </a>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td class=" text-center">
                                                    <div class="table-actions">
                                                        ...
                                                        {{-- <a href="{{ route('admin.ecommerce.edit_product', ['id' => $item->id]) }}" --}}
                                                        <a href="" class="btn btn-icon btn-sm btn-primary"
                                                            data-bs-toggle="tooltip" data-bs-original-title="Edit"><i
                                                                class="fa fa-edit"></i></a>

                                                        {{-- <a href="{{ route('admin.ecommerce.delete_product', ['id' => $item->id]) }}" --}}
                                                        <a href=""
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Export Location Data</h5>
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            ...
                            <label class="control-label">Ready to export all data</label>
                            <a href="{{ route('admin.exportLocation.export_location') }}" class="btn btn-success" style="background: green;">Export</a>
